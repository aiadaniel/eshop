 ...
 */
function login() {
    return location.href = "http://localhost:7084/page/login";
}
function regist() {
    return location.href = "http://localhost:7084/page/register";
}
...
function search(a) {
    var b = "http://127.0.0.1:7080/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
